          ...
          <Col span="10" className={cx('registerBox')}>
            <div className={cx('register-box')}>
              <div className={cx('new-reg-guide-login')}>
                ...
                <Form ref={this.formRef} name="register" onFinish={onFinish} scrollToFirstError>
                  <div style={{ textAlign: 'center', marginBottom: '10px' }}>
                    <Button
                      ...
                      style={isTeam ? {} : { border: '1px solid #1890ff', color: '#1890ff' }}
                      type="text"
                    >
                      游客注册
                    </Button>
                  ...
                  <div style={{ width: '100%', textAlign: 'center' }}>
                    <Button type="primary" htmlType="submit" className={cx('submitBtn')}>
                      注册
                    </Button>
                  </div>
                </Form>
